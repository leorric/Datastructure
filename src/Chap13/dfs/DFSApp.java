...
// ------------------------------------------------------------
   ...
   //ex 13.3
   public void produceConnectivityTable()  // depth-first search
   {                                 // begin at vertex 0
...
class DFSApp {
	...
	public void testTransitiveClosure() {
      ...
      theGraph.addSingleEdge(0, 1);     // AB
      theGraph.addSingleEdge(1, 2);     // BC
      theGraph.addSingleEdge(0, 3);     // AD
      theGraph.addSingleEdge(3, 4);     // DE

      int[][] closure = theGraph.getTransitiveClosure();
      //System.out.println(Arrays.toString(closure));
      int nVerts = closure.length;
      for(int i=0;i<nVerts ;i++) {
  		for(int j=0;j<nVerts;j++) {
   ...
   public void printConnectTable() {
	      ...
	      theGraph.produceConnectivityTable();
   }

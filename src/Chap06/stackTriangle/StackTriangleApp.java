      ...
      switch(codePart)
         ...
         case 2:                              // method entry
            ...
            if(theseParams.n == 1)            // test
               {
               //theAnswer = 1;      //commented out by yjj
               codePart = 4;   // exit   -- modified from 4 to 5 by yjj
               }
            else
         ...
         case 3:                              // method call
            ...
            System.out.println("case3 push:"+newParams.n);
            codePart = 2;  // go enter method
            break;
         case 4:                              // calculation (method execute - by yjj)
            theseParams = theStack.peek();
            theAnswer = theAnswer + theseParams.n;
            System.out.println("case4 calulate:"+theAnswer);
            codePart = 5;
            break;
         case 5:                              // method exit
            theseParams = theStack.peek();
